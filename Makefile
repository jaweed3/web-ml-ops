...
subset: ## Run full pipeline with subset dataset (Mac Mini: USE_SUBSET=true TRAIN_DEVICE=mps)
	USE_SUBSET=true TRAIN_DEVICE=mps uv run python -m pipeline.stage1_data
	USE_SUBSET=true TRAIN_DEVICE=mps uv run python -m pipeline.stage2_train
	USE_SUBSET=true TRAIN_DEVICE=mps uv run python -m pipeline.stage3_export
	USE_SUBSET=true TRAIN_DEVICE=mps uv run python -m pipeline.stage4_benchmark
	USE_SUBSET=true TRAIN_DEVICE=mps uv run python -m pipeline.stage5_register
